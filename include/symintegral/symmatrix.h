...
#ifndef SYMINTEGRATION_CPLUSPLUS_SYMBOLICMATRIX

#include "matrix.h"
using namespace std;

#ifdef  SYMBOLIC_FORWARD
#ifndef SYMINTEGRATION_CPLUSPLUS_SYMBOLICMATRIX_FORWARD
#define SYMINTEGRATION_CPLUSPLUS_SYMBOLICMATRIX_FORWARD
...
#define SYMINTEGRATION_CPLUSPLUS_SYMBOLICMATRIX
#ifndef SYMINTEGRATION_CPLUSPLUS_SYMBOLICMATRIX_DECLARE
#define SYMINTEGRATION_CPLUSPLUS_SYMBOLICMATRIX_DECLARE
