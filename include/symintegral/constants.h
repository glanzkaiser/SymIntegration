...
#ifndef SYMINTEGRATION_CPLUSPLUS_CONSTANTS

#ifdef  SYMBOLIC_DECLARE
#define SYMINTEGRATION_CPLUSPLUS_CONSTANTS
#ifndef SYMINTEGRATION_CPLUSPLUS_CONSTANTS_DECLARE
#define SYMINTEGRATION_CPLUSPLUS_CONSTANTS_DECLARE
