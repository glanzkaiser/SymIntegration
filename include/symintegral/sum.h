...
#ifndef SYMINTEGRATION_CPLUSPLUS_SUM

#include <list>
using namespace std;

#ifdef  SYMBOLIC_FORWARD
#ifndef SYMINTEGRATION_CPLUSPLUS_SUM_FORWARD
#define SYMINTEGRATION_CPLUSPLUS_SUM_FORWARD
...
#define SYMINTEGRATION_CPLUSPLUS_SUM
#ifndef SYMINTEGRATION_CPLUSPLUS_SUM_DECLARE
#define SYMINTEGRATION_CPLUSPLUS_SUM_DECLARE
