...
#include "symintegral/equation.h"  //   Equation : CloningSymbolicInterface
#include "symintegral/number.h"    //   Numeric  : CloningSymbolicInterface
...
#include "symintegral/artificialneuralnetworks.h"
...
Symbolic asin(const Symbolic &);
Symbolic cos(const Symbolic &);
Symbolic acos(const Symbolic &);
Symbolic tan(const Symbolic &);
Symbolic atan(const Symbolic &);
Symbolic cot(const Symbolic &);
Symbolic acot(const Symbolic &);
Symbolic sec(const Symbolic &);
Symbolic asec(const Symbolic &);
Symbolic csc(const Symbolic &);
Symbolic acsc(const Symbolic &);
Symbolic sinh(const Symbolic &);
Symbolic asinh(const Symbolic &);
Symbolic cosh(const Symbolic &);
Symbolic acosh(const Symbolic &);
Symbolic tanh(const Symbolic &);
Symbolic coth(const Symbolic &);
Symbolic sech(const Symbolic &);
Symbolic csch(const Symbolic &);
