...
int main(int argc, char** argv)
{
	...
	//hypothesistest_knownvariances_righttailed(x,y,2,5.2,3.4,0.05,1);
	//hypothesistest_knownvariances_lefttailed(x,y,2,5.2,3.4,0.05,1);
	hypothesistest_knownvariances_twotailed(x,y,0,5.2,3.4,0.05,1);
