...
int main(int argc, char** argv)
{
	...
	cout << "\nTraining Feed-forward Neural Network with 1 hidden layer for Iris dataset:" << endl;
	//FNN_1hiddenlayer_irisdataset_training(X_train,y_train);
	
	cout << "\nTesting Feed-forward Neural Network with 1 hidden layer for Iris dataset:" << endl;
	//FNN_1hiddenlayer_irisdataset_testing(X_test,y_test);
	FNN_1hiddenlayer_irisdataset_testing(irisMatrix,vec_x5);
